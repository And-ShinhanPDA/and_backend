...
@Slf4j
@ConditionTypeMapping(ConditionType.SMA_5_UP)
@Component
public class SMA5UpEvaluator extends BaseRedisEvaluator {

    public SMA5UpEvaluator(RedisTemplate<String, Object> redisTemplate,
    ...
    public boolean evaluate(Long alertId, Long conditionId, String stockCode) {
        ...
        log.info("[SMA_20_UP] alertId={} stock={} sma5={} threshold={} → {}",
