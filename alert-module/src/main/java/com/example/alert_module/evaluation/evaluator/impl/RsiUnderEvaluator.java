...
@Component
public class RsiUnderEvaluator extends BaseRedisEvaluator {

    public RsiUnderEvaluator(RedisTemplate<String, Object> redisTemplate, AlertConditionManagerRepository managerRepo) {
    ...
    public boolean evaluate(Long alertId, Long conditionId, String stockCode) {
        ...
        Double rsi = d(daily.get("rsi14")); // 일별 rsi값
