...
@Slf4j
@ConditionTypeMapping(ConditionType.SMA_20_DOWN)
@Component
public class SMA20DownEvaluator extends BaseRedisEvaluator {

    public SMA20DownEvaluator(RedisTemplate<String, Object> redisTemplate,
    ...
    public boolean evaluate(Long alertId, Long conditionId, String stockCode) {
        ...
        log.info("[SMA_20_DOWN] alertId={} stock={} sma20={} threshold={} → {}",
